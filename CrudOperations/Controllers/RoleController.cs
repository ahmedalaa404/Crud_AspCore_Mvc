...
namespace CrudOperations.Controllers
{
	public class RoleController : Controller
	{
		...
		public async Task<IActionResult> Index(string SearchValue)
		{
			...
			{
				var RolesNames = await _roleManager.FindByNameAsync(SearchValue);
				var RoleViewModelSearch = new RoleViewModel()
				{
					id = RolesNames.Id,
					RoleName = RolesNames.Name
				} ;
				var x = new List<RoleViewModel>()
				{
					RoleViewModelSearch
